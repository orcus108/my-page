...
export async function buildPersSite({ rootDir, root, projects, posts, aboutHtml, renderMarkdown, siteUrl, basePath = "/", outputDir = "" }) {
  ...
  const home = `<main class="home">${header(0, "contact")}<div class="home-intro"><div class="identity"><h1>Vedant Misra</h1><p>Product builder</p></div><div class="statement"><p>There is a growing gap between what AI can do and what most people can actually get out of it.</p><p>I build in that gap, starting with what people need and working backwards to make powerful technology feel obvious to use.</p><p>If you’re working on the same problem, <a href="mailto:${EMAIL}">let’s talk!</a></p><div class="socials"><a href="mailto:${EMAIL}">email</a><span class="separator" aria-hidden="true">·</span><a href="${X_URL}" target="_blank" rel="noopener noreferrer">x (twitter)</a><span class="separator" aria-hidden="true">·</span><a href="${LINKEDIN_URL}" target="_blank" rel="noopener noreferrer">linkedin</a></div></div></div><section class="home-section writing"><h2>Writing</h2><div><p class="section-note">Things I’ve been thinking about</p><ul class="link-list"><li><a href="writing/broke-countries-build-different.html">Broke Countries Build Different</a></li><li><a href="writing/ai-and-human-identity.html">AI and Human Identity</a></li></ul></div></section><section class="home-section projects"><h2>Projects</h2><div><p class="section-note">What I’ve been building</p><ul class="link-list"><li><a href="projects/workprint.html">Workprint</a></li><li><a href="projects/sakhi.html">Sakhi</a></li><li><a href="projects/friday.html">Friday</a></li></ul></div></section><footer class="home-footer"><span><span class="desktop-only">Sophomore @ IIT Madras · Building across AI, product, and design</span><span class="mobile-only">Sophomore at IIT Madras</span></span><span>Hyderabad, India</span></footer></main>`;
  const homeWritingSlugs = ["broke-countries-build-different", "what-if-the-future-goes-right"];
  const latestWriting = homeWritingSlugs
