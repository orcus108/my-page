...
const css = `
  ...
  *{box-sizing:border-box}
  ...
  .socials .contact-mark{width:20px;height:20px;display:block}.socials .contact-mark path{fill:none;stroke:currentColor;stroke-width:1.6;stroke-linecap:round;stroke-linejoin:round}.socials .x{width:20px;height:20px}.socials .linkedin{width:18px;height:18px;border-radius:2px;background:var(--ink);color:var(--paper);font-size:13px;font-weight:700;line-height:18px;text-align:center}
