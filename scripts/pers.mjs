...
const css = `
  ...
  *{box-sizing:border-box}
  ...
  .socials .contact-mark{width:20px;height:20px;font-size:17px;line-height:20px;font-weight:400}.socials .x{width:20px;height:20px}.socials .linkedin{width:18px;height:18px;border-radius:2px;background:var(--ink);color:var(--paper);font-size:13px;font-weight:700;line-height:18px;text-align:center}
